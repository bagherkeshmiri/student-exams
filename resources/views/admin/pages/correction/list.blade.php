                                            ...
                                            <table class="table mb-0 table-hover">
                                                ...
                                                @forelse ($questions as $question)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @include('frest-components.inputs.buttons.tiny.link.icon-btn',[  'href' => route('admin.correction.show',[ 'question' => $question->id ])  , 'tooltip_title' => 'تصحیح' , 'icon' => '<i class="bx bx-pencil bx-sm bx-tada-hover" style="color:#FDAC41 !important;"></i>'])
                                                        </td>
                                                    </tr>
                                                @empty
                                                    <tr>
