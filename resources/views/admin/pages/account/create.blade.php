            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1 text-success " style=" border-left: 0 !important;">ایجاد مدیر</h5>
                        </div>
                    </div>
                </div>
            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            @include('frest-components.tags.required-tag')
                                                            @include('frest-components.inputs.select2.simple',[ 'data' => $roles , 'id' => 'role' , 'name' => 'role' ])
                                                    ...
                                                    <div class="col-12 d-flex justify-content-end">
                                                        ...
                                                        @include('frest-components.inputs.buttons.link-button',[ 'href' => route('admin.admin.index') , 'classes' => 'btn btn-danger mr-1 mb-1' , 'id' => 'cancel' , 'content' => __('global.cancel')  , 'icon' => arrowIcon() ])
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
