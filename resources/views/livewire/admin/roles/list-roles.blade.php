                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0 table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <th style="width: 120px;">نام انگلیسی</th>
                                                <th>سطوح دسترسی</th>
                                                <th>عملیات</th>
                                            </tr>
                                            </thead>
                                            ...
                                            @forelse ($roles as $role)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @include('frest-components.inputs.buttons.tiny.link.icon-btn',[  'href' => route('admin.panel.role.show',[ 'role' => $role->id ])  , 'tooltip_title' => 'ویرایش' , 'icon' => '<i class="bx bx-pencil bx-sm bx-tada-hover" style="color:#FDAC41 !important;"></i>'])
                                                    </td>
                                                </tr>
                                            @empty
                                                <tr>
