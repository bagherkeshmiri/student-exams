                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($question->status == $question_new_status)
                                                            @include('frest-components.inputs.buttons.tiny.link.icon-btn',[  'href' => route('admin.panel.question.show',[ 'question' => $question->id ])  , 'tooltip_title' => 'ویرایش' , 'icon' => '<i class="bx bx-pencil bx-sm bx-tada-hover" style="color:#FDAC41 !important;"></i>'])
                                                            @include('frest-components.inputs.buttons.tiny.link.icon-btn',[ 'tooltip_title' => 'حذف' , 'icon' => '<i class="bx bx-trash bx-sm bx-tada-hover" style="color:#FF5B5C !important;"></i>' , 'attributes' => 'onclick=student_delete(this,event)  data-url='.route('admin.panel.question.delete',[ 'question' => $question->id ]) ])
                                                        @endif
                                                    </td>
                                                </tr>
                                            @empty
